...
public class SeleniumDockerBrowser
{
    @Test
    void testDockerBrowserSelenium(@DockerBrowser(type =  FIREFOX) WebDriver driver) {
        driver.get("https://blazedemo.com/");
        //assertThat(driver.getTitle()).contains("Selenium WebDriver");


        // Configura o tamanho da janela
        driver.manage().window().setSize(new org.openqa.selenium.Dimension(1902, 442));
